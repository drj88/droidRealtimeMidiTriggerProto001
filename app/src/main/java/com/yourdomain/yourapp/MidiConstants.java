...
public class MidiConstants {
    ...
    public final static int MIDI_NOTE_NUMBER_MIN = 21;
    public final static int MIDI_NOTE_NUMBER_MAX = 108;

    public final static int MAX_CHANNELS = 16;

    public final static int MAX_PATCH = 128;

    public final static int MAX_VELOCITY = 128;
